...
**`xcNamespace`** — Every resource requires this field to specify the F5 XC namespace. This is independent of the Kubernetes namespace. Resources that reference each other must share the same `xcNamespace`.
